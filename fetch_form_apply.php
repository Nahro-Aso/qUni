<!-- this screen contain a table which shows the results of student refistration -->
...
<div class="navbar">
    ...
    <a href="life_in_kurdstan.html">Life In Kurdisstan</a>
...
textarea {
    ...
    height: 75%;
    object-fit: cover;" src="images/a-book-4126481.jpg" alt="">
    

</div>
<h1 style="padding: 50px 0px 0px 100px;">Student Registration</h1> 
<br>
<br>

    <form style="padding: 0px 0px 0px 100px; display:flex" action="">
